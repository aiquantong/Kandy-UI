...
static const int Toast_tag                      = 91234;
...
{
    UIView *beforeToast = [self viewWithTag:Toast_tag];
    if (beforeToast) {
        [self hideToast:beforeToast];
    }
...
- (void)makeToastActivity:(id)position {
    ...
    activityView.layer.borderColor = [UIColor whiteColor].CGColor;
    activityView.layer.borderWidth = 0.5f;
    
    if (CSToastDisplayShadow) {
        activityView.layer.shadowColor = [UIColor grayColor].CGColor;
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    wrapperView.layer.borderWidth = 0.5f;
