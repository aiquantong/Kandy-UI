...
typedef NS_ENUM(NSInteger, EKandyCallServiceError) {
     ...
     */
    EKandyCallServiceError_cameraNotAvailable,
    /**
...
typedef NS_ENUM(NSInteger, EKandyCallState) {
    EKandyCallState_unknown             = 0, /* Unknown state of the call*/
    EKandyCallState_initialized         /*= 1*/, /* Initialized state */
    EKandyCallState_dialing             /*= 2*/, /* Waiting for network to reach the callee */
    EKandyCallState_sessionProgress     /*= 3*/, /* Conveying information about the progress of the call. Used to inform about recieving early media while ringing */
	EKandyCallState_ringing             /*= 4*/, /* Callee is found and ringing or current device got incoming call and pending decision */
    EKandyCallState_answering           /*= 5*/, /* Waiting for call to be connected */
	EKandyCallState_talking             /*= 6*/, /* Call session is in talking mode */
	EKandyCallState_terminated          /*= 7*/, /* Call has ended */
	EKandyCallState_notificationWaiting /*= 8*/, /* Waiting for incoming call, got a call by push, but the system still not connected */
