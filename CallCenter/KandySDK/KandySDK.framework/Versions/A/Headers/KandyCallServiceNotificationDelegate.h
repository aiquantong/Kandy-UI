...
/**
 *  Got missed call.
 *  Should mark the missed Call as received in order notify the server that we got it.
 *
 ...
 *  Should mark the pendingVoiceMail as received in order notify the server that we got it.
 *
