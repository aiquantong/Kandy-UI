...
/**
 *  Send a typing indication to other user
 *
 *  @param typingIndication the typing indication object describing current typing state of the current provisoned user
 *  @param destination      the other user which should recieve typing indication from current provisioned user
 *  @param responseCallback the callback that provides error on failure, or nil when sending typing indication succeeded
 */
-(void) sendUserTypingIndication:(KandyTypingIndication*)typingIndication destination:(KandyRecord*)destination responseCallback:(void(^)(NSError* error))responseCallback;
