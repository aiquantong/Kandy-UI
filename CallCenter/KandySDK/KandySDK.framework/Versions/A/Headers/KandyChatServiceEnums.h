...
//    EKandyChatServiceError_operationCanceled,
    /**
     *  User has no enough credits to send this SMS
     */
    EKandyChatServiceError_notEnoughCreditsToSendSMS,
};
...
/**
 *  Typing state of the user
 */
typedef NS_ENUM(NSInteger, EKandyUserTypingIndicationState) {
    /**
     *  User is typing
     */
    EKandyUserTypingIndicationState_typing,
    /**
     *  User ended typing
     */
    EKandyUserTypingIndicationState_idle,
};
...
extern "C" {
    ...
    NSString* EKandyUserTypingIndicationStateToString(EKandyUserTypingIndicationState state);
