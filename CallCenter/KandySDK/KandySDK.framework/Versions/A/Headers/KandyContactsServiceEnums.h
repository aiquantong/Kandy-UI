...
typedef NS_ENUM(NSUInteger, EKandyContactsServiceError) {
     ...
     */
    EKandyContactsServiceError_vCardChangeFailed,
    /**
     *  Could not get contacts
     */
    EKandyContactsServiceError_vCardDeletionFailed,
    /**
     *  Upload contacts failed
     */
    EKandyContactsServiceError_uploadAddressBookFailed,
    /**
     *  Download contacts failed
     */
    EKandyContactsServiceError_downloadAddressBookFailed,
    /**
     *  Delete contacts failed
     */
    EKandyContactsServiceError_deleteAddressBookFailed,
    /**
     *  Get hints for contacts failed
     */
    EKandyContactsServiceError_getAddressBookHintsFailed,
    /**
