...
@interface KandyGroupParticipantLeft : KandyBaseEvent
 ...
 */
-(instancetype)initWithUUID:(NSString*)aUuid timestamp:(NSDate*)aTimestamp groupId:(KandyRecord*)aGroupId leaver:(KandyRecord*)aLeaver admins:(NSArray*)aAdmins origin:(EKandyEventOrigin)anOrigin;
