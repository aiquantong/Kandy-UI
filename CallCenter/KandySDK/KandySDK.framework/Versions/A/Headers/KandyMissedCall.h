...
@interface KandyMissedCall : KandyBaseEvent
 ...
 */
-(id) initWithCallId:(NSString*)callId uuid:(NSString*)aUUID caller:(KandyRecord*)aCaller callType:(EKandyCallType)aCallType isVideo:(BOOL)aIsVideo timestamp:(NSDate*)aTimestamp via:(NSString*)aVia origin:(EKandyEventOrigin)anOrigin pushType:(EKandyEventPushType)pushType;
