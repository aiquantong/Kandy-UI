...
typedef NS_ENUM(NSInteger, EKandyNotificationServiceError) {
    ...
    /**
     *  Failed to delete push credentials on server
     */
    EKandyNotificationServiceError_deletePushCredentialsFailed,
    /**
     *  Failed to get current push credetials from server
     */
    EKandyNotificationServiceError_getPushCredentialsFailed,
    /**
     *  Failed to update push credentials on server
     */
    EKandyNotificationServiceError_updatePushCredentialsFailed,
    /**
     *  For development
     */
