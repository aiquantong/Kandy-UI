...
@interface KandyPendingIncomingCallEvent : KandyBaseEvent
 ...
 *  @param orign            The origin of the event
 *  @param pushType         The push type of this event
 *
 *  @return Initialized KandyPendingIncomingCall
 */
-(id) initWithCallId:(NSString*)aCallId caller:(KandyRecord*)aCaller callType:(EKandyCallType)aCallType isVideo:(BOOL)aIsVideo timestamp:(NSDate*)aTimestamp via:(NSString*)aVia sdp:(NSString*)sdp origin:(EKandyEventOrigin)origin pushType:(EKandyEventPushType)pushType;
