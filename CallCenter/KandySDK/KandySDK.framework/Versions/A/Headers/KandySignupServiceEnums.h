...
//    EKandySignupServiceError_userNotFound = 1004,
    ...
    EKandySignupServiceError_invalidValidationCode, /** validation code is not match */
    ...
    EKandySignupServiceError_incorrectNumber,
    EKandySignupServiceError_userAlreadyExists,
